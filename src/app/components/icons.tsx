...
export const MoonIcon: React.FC<MoonIconProps> = (props: MoonIconProps) => {
    const palette = useTheme().palette
    const borderThickness = props.size / 16
    const craterThickness = props.size / 25
    const craterStyle = {
        border: `${craterThickness}px solid ${
            palette.mode === 'light'
    ...
    return (
        ...
        >
            <div className={styles.crater} style={craterStyle}></div>
            <div className={styles.crater} style={craterStyle}></div>
            <div className={styles.crater} style={craterStyle}></div>
            <div className={styles.crater} style={craterStyle}></div>
            <div className={styles.crater} style={craterStyle}></div>
